...
  payload.titular = '0'; 
  payload.lancado = 'Y'; // Se deseja que ao criar, ele já vá como Lançado/Ativo ('Y')
  
...
// ======================================================================
// ✅ NOVO SERVIÇO: ATUALIZAR STATUS DE LANÇAMENTO (para o Toggle no Dashboard)
// ======================================================================
export const atualizarStatusLancamento = async (id, isLancado) => {
  // Converte o booleano do frontend (true/false) para o formato do banco ('Y'/'N')
  const statusBackend = isLancado ? 'Y' : 'N'; 
  
  const payload = {
    // A rota PUT no backend já aceita payload parcial, o que torna essa chamada válida.
    lancado: statusBackend,
  };

  // Usa a rota de PUT existente
