        ...
        <div className="bg-white rounded-2xl shadow-md p-5 mb-6 border border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4 items-end">
            ...
            <div className="flex flex-col gap-1">
                <label className="text-xs font-semibold text-gray-500 uppercase">Status Lançado</label>
                <select 
            ...
            <div className="flex flex-col gap-1">
                <label className="text-xs font-semibold text-gray-500 uppercase">Forma Pagto</label>
                <select 
             ...
             {/* Filtro: Data */}
             <div className="flex flex-col gap-1">
                <label className="text-xs font-semibold text-gray-500 uppercase">Data Lançamento</label>
                <input 
                  type="date" 
                  name="data" 
                  value={filters.data} 
             ...
             {/* Filtro: Obra */}
             <div className="flex flex-col gap-1">
                <label className="text-xs font-semibold text-gray-500 uppercase">Obra</label>
                <select 
                  name="obra" 
                  value={filters.obra} 
                  onChange={handleFilterChange}
             ...
             {/* Filtro: Titular */}
             <div className="flex flex-col gap-1">
                <label className="text-xs font-semibold text-gray-500 uppercase">Titular</label>
                <select 
                  name="titular" 
                ...
                >
                  ...
                  {Object.keys(mockTitulares).map(id => (
                    <option key={id} value={id}>{mockTitulares[id]}</option>
                  ))}
                </select>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-x-auto">
          {filteredRequests.length === 0 ? (
            <div className="p-12 text-center text-gray-500">
              {requests.length === 0 ? "Nenhuma solicitação encontrada no sistema." : "Nenhum resultado para os filtros aplicados."}
            </div>
          ) : (
